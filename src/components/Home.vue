                ...
                <ul>
                  <li class="onhover-div mobile-setting">
                    ...
                    <div class="show-div setting">
                      <h5>Idioma</h5>
                      <ul>
                        <li><a href="/pt" class="navbar-item">Português</a></li>
                        <li><a href="/en" class="navbar-item">English</a></li>
                      </ul>
                      <h5>Outro</h5>
                      <ul>
                        <li><a href="/teste" class="navbar-item">teste</a></li>
                        <li><a href="/teste2" class="navbar-item">teste2</a></li>
                      </ul>
                    </div>
                  </li>
                  <li class="onhover-div mobile-setting">
                    ...
                    <div class="show-div cart-table">
                      <div class="cart-items">
                        <div v-for="(item, index) in cart" :key="index" class="cart-item" :class="{'cart-item-added': item.added}">
